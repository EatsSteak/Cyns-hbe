...
if game.GameId ~= 142553158 then return;end;
(function()
...
messagebox("Hi", "Successfully bypassed", 1);

task.wait(3.5)

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()

local Window = Library.CreateLib("XYZ HBE", "BloodTheme")

local Tab = Window:NewTab("Xyz HBE")

local sec = Tab:NewSection("XYZ HBE Style")

sec:NewButton("HBE", "Epic", function()
...
Settings.HITBOX.Size = Vector3.new(12,12,12);
Settings.HITBOX.Transparency = 25;
Settings.TARGETHITBOX.Size = Vector3.new(15,15,15);
Settings.TARGETHITBOX.Transparency = 25;

Settings.INST.FillColor = Color3.fromRGB(222, 2, 222);
Settings.TARGET.OutlineColor = Color3.fromRGB(111, 11, 111);
end)

sec:NewKeybind("Press LeftAlt to hide the gui", "Hides the entire gui", Enum.KeyCode.LeftAlt, function()
    Library:ToggleUI()
end)